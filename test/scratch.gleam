...
pub fn main() {
  jsonpath.parse_path("$") |> echo
  jsonpath.parse_path("$.") |> echo
  jsonpath.parse_path("$.test") |> echo
  jsonpath.parse_path("$['test']") |> echo
  jsonpath.parse_path("$['te\\fst']") |> echo
  jsonpath.parse_path("$['te\\zst']") |> echo
  jsonpath.parse_path("$['te\\uD050st']") |> echo
  jsonpath.parse_path("$['te\\uD800st']") |> echo
  jsonpath.parse_path("$['te\\uD800\\uDc01st']") |> echo
  jsonpath.parse_path("$.*") |> echo
  jsonpath.parse_path("$[*]") |> echo
  jsonpath.parse_path("$[0]") |> echo
  jsonpath.parse_path("$[1]") |> echo
  jsonpath.parse_path("$[1-1]") |> echo
  jsonpath.parse_path("$[101]") |> echo
  jsonpath.parse_path("$[-1]") |> echo
  jsonpath.parse_path("$[-0]") |> echo
  jsonpath.parse_path("$[-01]") |> echo
  jsonpath.parse_path("$[00]") |> echo
  jsonpath.parse_path("$[09]") |> echo
}
